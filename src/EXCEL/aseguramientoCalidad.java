 ...
 * @author luisg
 */
public class aseguramientoCalidad extends javax.swing.JFrame {

    /**
     * Creates new form gRequisitos
     */
    String[] preguntas = new String[14];
    int[] respuestas = new int[14];
    int index = 0;
    
    public aseguramientoCalidad() {
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        preguntas = LeerExcel.leerPreguntasAseguramientoDeLaCalidad();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aseguramientoCalidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new aseguramientoCalidad().setVisible(true);
            }
        });
    }
